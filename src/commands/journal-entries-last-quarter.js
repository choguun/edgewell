// `edgewell journal-entries-last-quarter` lists the journal
// entries for the previous quarter.
...
export async function journalEntriesLastQuarterCommand(_args, ew) {
